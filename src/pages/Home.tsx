  ...
  return (
    <div className='bg-gradient-to-br from-gray-900 to-gray-800'>
      <header className='p-6'>
        <h1 className='text-3xl font-bold text-white'>Welcome to Dota2 Stats</h1>
        <p className='text-gray-400 mt-2'>
          A modern application for tracking Dota 2 statistics
        </p>
      </header>
      ...
      <div className='grid grid-cols-1 md:grid-cols-3 gap-6'>
        ...
        <div className='bg-gray-800 rounded-lg p-6 border border-gray-700'>
          <h2 className='text-xl font-semibold text-white mb-4'>React Router</h2>
          <p className='text-gray-400'>Client-side routing for navigation</p>
        </div>
      </div>
